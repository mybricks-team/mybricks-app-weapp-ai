                  ...
                  exportActions={[
                    {
                      ...
                      onClick: async () => {
                        ...
                        let files = com.model.data.files
                        ...
                        files = transformer.transformFiles(files.map((file) => {
                          return {
                            ...file,
                            path: file.fileName,
                        ...
                        console.log('[transformedFiles]', files)
                        ...
                        try {
                          for (let i = 0; i < files.length; i++) {
                            ...
                            await writeFile(appDir, file.path, file.content)
                          }
                          message.open({
                            key: messageKey,
                            type: 'success',
